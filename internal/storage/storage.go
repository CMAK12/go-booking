...
type (
	...
	BookingStorage interface {
		List(ctx context.Context, filter ListBookingFilter) ([]models.Booking, int64, error)
	...
	HotelStorage interface {
		List(ctx context.Context, filter ListHotelFilter) ([]models.Hotel, int64, error)
	...
	RoomStorage interface {
		List(ctx context.Context, filter ListRoomFilter) ([]models.Room, int64, error)
	...
	ExtraServiceStorage interface {
		List(ctx context.Context, filter ListExtraServiceFilter) ([]models.ExtraService, int64, error)
