...
type (
	...
	BookingService interface {
		List(ctx context.Context, filter storage.ListBookingFilter) ([]dto.ListBookingResponse, int64, error)
	...
	HotelService interface {
		List(ctx context.Context, filter storage.ListHotelFilter) ([]models.Hotel, int64, error)
	...
	RoomService interface {
		List(ctx context.Context, filter storage.ListRoomFilter) ([]dto.ListRoomResponse, int64, error)
	...
	ExtraServiceService interface {
		List(ctx context.Context, filter storage.ListExtraServiceFilter) ([]models.ExtraService, int64, error)
