...
type (
	...
	BookingService interface {
		List(ctx context.Context, filter dto.ListBookingFilter) ([]dto.ListBookingResponse, int64, error)
	...
	RoomService interface {
		List(ctx context.Context, filter dto.ListRoomFilter) ([]dto.ListRoomResponse, int64, error)
